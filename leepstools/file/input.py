...
class Input:
    def __init__(self):
        ...
        self.source_angle = Parameter("SCONE", (0.0, 0.0, 0.1146), "Conical beam; angles in deg", float)
        ...
        self.spectrometer_angle = Parameter("SPCANG", (0.0, 0.0, 0.5730), "Spectrometer directions; angles in deg", float)
    ...
    def read(self, file_path):
        with open(file_path) as input_file:
            ...
            for line in lines:
                ...
                extract_value_from_line(self.source_angle, keyword, value_string)
                ...
                extract_value_from_line(self.spectrometer_angle, keyword, value_string)
