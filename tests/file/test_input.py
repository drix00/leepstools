...
class TestInput(unittest.TestCase):
    ...
    def test_read(self):
        ...
        self.assertEqual((0.0, 0.0, 0.1146), input_file.source_angle.value)
        self.assertEqual(1e-5, input_file.thickness_cm.value)
        self.assertEqual(50.0, input_file.absorption_energy_eV.value)
        self.assertEqual((0.0, 0.0, 0.5730), input_file.spectrometer_angle.value)
    ...
    def test_write(self):
        ...
        self.assertEqual(input_file_ref.source_angle.value, input_file.source_angle.value)
        ...
        self.assertEqual(input_file_ref.spectrometer_angle.value, input_file.spectrometer_angle.value)
