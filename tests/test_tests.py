...
"""
.. py:currentmodule:: tests.test_tests

.. moduleauthor:: Hendrix Demers <hendrix.demers@mail.mcgill.ca>

Tests for the package :py:mod:`tests`.
"""
...
class TestPath(unittest.TestCase):
    """
    TestCase class for the package `tests`.
    """
    ...
    def test_is_git_lfs_file_bad(self):
        file_path = resource_filename(__name__, "test_tests.py")

        self.assertEqual(False, tests.is_git_lfs_file(file_path))

        # self.fail("Test if the testcase is working.")

    def test_is_git_lfs_file_good(self):
        self.assertEqual(True, tests.is_git_lfs_file(self.git_lfs_file))
    ...
    def test_is_bad_file(self):
        ...
        self.assertEqual(False, tests.is_bad_file(file_path))

        # self.fail("Test if the testcase is working.")

    def test_is_bad_file_git_lfs(self):
        self.assertEqual(True, tests.is_bad_file(self.git_lfs_file))
